...
var mapView = function () {
  ...
  this.initialise = function(geoData, geoCodeRegEx) {
    ...
    $('#map').sdgMap({
      ...
      mapOptions: {"minZoom":5,"maxZoom":10,"tileURL":"https://api.tiles.mapbox.com/v4/{id}/{z}/{x}/{y}.png?&access_token={accessToken}","tileOptions":{"id":"mapbox.light","accessToken":"pk.eyJ1IjoiY2hyaXN0b3BoNDcxMSIsImEiOiJjanp1cmJ2b2swMTNhM2xtdzEzMXdoN3A0In0.AAEE_ki991FcAOQ_piKr9Q","attribution":"<a href=\"https://www.bkg.bund.de\">© GeoBasis-DE / BKG</a>"},"colorRange":"chroma.brewer.BuGn","noValueColor":null,"styleNormal":{"weight":1,"opacity":1,"color":null,"fillOpacity":0.7},"styleHighlighted":{"weight":1,"opacity":1,"color":null,"fillOpacity":0.7},"styleStatic":{"weight":2,"opacity":1,"fillOpacity":0,"color":null,"dashArray":55}},
      mapLayers: [{"serviceUrl":"https://christoph4711.github.io/open-sdg-site-starter/assets/maps/NI_GJ.geojson","nameProperty":"GEN","idProperty":"AGS","min_zoom":0,"max_zoom":20,"staticBorders":false}],
    });
  };
};
