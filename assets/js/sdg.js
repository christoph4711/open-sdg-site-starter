...
var mapView = function () {
  ...
  this.initialise = function(geoData, geoCodeRegEx) {
    ...
    $('#map').sdgMap({
      ...
      mapOptions: {"minZoom":5,"maxZoom":10,"tileURL":"https://api.tiles.mapbox.com/v4/{id}/{z}/{x}/{y}.png?&access_token={accessToken}","tileOptions":{"id":"mapbox.light","accessToken":"pk.eyJ1IjoibW9ib3NzZSIsImEiOiJjanplNTNhMmQwMTFjM21wNHEzazRlejhwIn0.ecHE5G83cklfW5AXYjI_0A","attribution":"<a href=\"https://www.bkg.bund.de\">© GeoBasis-DE / BKG</a>"},"colorRange":"chroma.brewer.BuGn","noValueColor":null,"styleNormal":{"weight":1,"opacity":1,"color":null,"fillOpacity":0.7},"styleHighlighted":{"weight":1,"opacity":1,"color":null,"fillOpacity":0.7},"styleStatic":{"weight":2,"opacity":1,"fillOpacity":0,"color":null,"dashArray":55}},
